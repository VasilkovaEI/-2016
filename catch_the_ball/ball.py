...
ball_available_colors = ['green', 'blue', 'red', 'lightgrey','#FF00FF','#FFFF00']

def click_ball(event):
    """ Обработчик событий мышки  для  игрового холста canvas.
    :param event: событие с координатами клика
    По клинку мышуой удалять тот объект, на который мышка указывает.
...
def move_all_balls(event):
    """Перемещает шарики на чуть-чуть"""
